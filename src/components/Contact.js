  ...
  return (
    <div id="contact" className={classes.root}>
      <div className={classes.body}>
        ...
        <Typography variant="h6">Book your class Now</Typography>
        <div className={classes.links}>
          <Link href="tel:+49 177 169 0204" className={classes.link}>
            <Typography className={classes.liknkKey}>
              Phone/Whatsapp:
            </Typography>
            <Typography> +49 177 169 0204</Typography>
          </Link>
          <Link
            href="mailto:filipedesouzapersonaltrainer@gmail.com"
          ...
          >
            ...
            <Typography>
              filipedesouzapersonaltrainer@gmail.com
            </Typography>
          </Link>
        </div>
      </div>
